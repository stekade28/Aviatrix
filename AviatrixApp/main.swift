...
func refuel(myPlane : Aviatrix) {
    ...
    print("⛽ You refueled \(Double(plane.maxFuel) - plane.fuelLevel) gallons totaling \(refuelData[plane.location]! * Double(plane.distanceTraveled))")
...
var plane = Aviatrix(plane1Author: "Puppy")

print("Welcome to the Aviatrix Flight System by Puppy")
plane.start()

print("You're currently in St. Louis")
...
print(" ")
print("Thanks for flying with Puppy airline!")
